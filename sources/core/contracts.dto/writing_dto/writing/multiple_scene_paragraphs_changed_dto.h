...
class MultipleSceneParagraphsChangedDTO
{
    Q_GADGET
  ...
  public:
    MultipleSceneParagraphsChangedDTO()
    ...
    MultipleSceneParagraphsChangedDTO(int sceneId, int parapgraphIndex, const QList<int> &paragraphIdList,
    ...
    MultipleSceneParagraphsChangedDTO(const MultipleSceneParagraphsChangedDTO &other)
    ...
    MultipleSceneParagraphsChangedDTO &operator=(const MultipleSceneParagraphsChangedDTO &other)
    {
        if (this != &other)
        {
    ...
    friend bool operator==(const MultipleSceneParagraphsChangedDTO &lhs, const MultipleSceneParagraphsChangedDTO &rhs);

    friend uint qHash(const MultipleSceneParagraphsChangedDTO &dto, uint seed) noexcept;
...
inline bool operator==(const MultipleSceneParagraphsChangedDTO &lhs, const MultipleSceneParagraphsChangedDTO &rhs)
{
...
inline uint qHash(const MultipleSceneParagraphsChangedDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(Contracts::DTO::Writing::MultipleSceneParagraphsChangedDTO)
