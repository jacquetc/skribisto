...
class SceneParagraphChangedDTO
{
  ...
  public:
    SceneParagraphChangedDTO() : m_paragraphId(0), m_paragraphUuid(QUuid()), m_text(QString())
    {
    }
    ...
    SceneParagraphChangedDTO(int paragraphId, const QUuid &paragraphUuid, const QString &text)
