...
class SceneParagraphChangedDTO
{
  ...
  public:
    SceneParagraphChangedDTO() : m_paragraphId(0), m_paragraphUuid(QUuid()), m_text(QString()), m_cursorPosition(0)
    {
    }
    ...
    SceneParagraphChangedDTO(int paragraphId, const QUuid &paragraphUuid, const QString &text, int cursorPosition)
