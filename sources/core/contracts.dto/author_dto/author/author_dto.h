...
public:
    ...
    AuthorDTO(const AuthorDTO& other) : m_id(other.m_id), m_uuid(other.m_uuid), m_creationDate(other.m_creationDate),
    ...
    friend bool operator==(const AuthorDTO& lhs,
                           const AuthorDTO& rhs);


    friend uint qHash(const AuthorDTO& dto,
                      uint             seed) noexcept;
