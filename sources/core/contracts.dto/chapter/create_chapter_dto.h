...
class CreateChapterDTO
{
  ...
  public:
    ...
    CreateChapterDTO( const QUuid &uuid,   const QDateTime &creationDate,   const QDateTime &updateDate,   const QString &title,   const QList<SceneDTO> &scenes ) 
        : m_uuid(uuid), m_creationDate(creationDate), m_updateDate(updateDate), m_title(title), m_scenes(scenes)
    {
    }

    CreateChapterDTO(const CreateChapterDTO &other) : m_uuid(other.m_uuid), m_creationDate(other.m_creationDate), m_updateDate(other.m_updateDate), m_title(other.m_title), m_scenes(other.m_scenes)
    {
    }
...
inline bool operator==(const CreateChapterDTO &lhs, const CreateChapterDTO &rhs)
{
    ...
    return 
            lhs.m_uuid == rhs.m_uuid  && lhs.m_creationDate == rhs.m_creationDate  && lhs.m_updateDate == rhs.m_updateDate  && lhs.m_title == rhs.m_title  && lhs.m_scenes == rhs.m_scenes 
    ;
}
