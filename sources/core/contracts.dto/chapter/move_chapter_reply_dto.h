...
class MoveChapterReplyDTO
{
  ...
  public:
    MoveChapterReplyDTO() : m_originBookId(0), m_targetedChapterId(0), m_scenePositionAtOrigin(0), m_destinationChapterId(0), m_scenePositionAtDestination(0)
    {
    }
    ...
    MoveChapterReplyDTO( int originBookId,   int targetedChapterId,   int scenePositionAtOrigin,   int destinationChapterId,   int scenePositionAtDestination ) 
        : m_originBookId(originBookId), m_targetedChapterId(targetedChapterId), m_scenePositionAtOrigin(scenePositionAtOrigin), m_destinationChapterId(destinationChapterId), m_scenePositionAtDestination(scenePositionAtDestination)
    {
    }

    MoveChapterReplyDTO(const MoveChapterReplyDTO &other) : m_originBookId(other.m_originBookId), m_targetedChapterId(other.m_targetedChapterId), m_scenePositionAtOrigin(other.m_scenePositionAtOrigin), m_destinationChapterId(other.m_destinationChapterId), m_scenePositionAtDestination(other.m_scenePositionAtDestination)
    {
    }
    ...
    friend bool operator==(const MoveChapterReplyDTO &lhs, const MoveChapterReplyDTO &rhs);


    friend uint qHash(const MoveChapterReplyDTO &dto, uint seed) noexcept;
...
inline bool operator==(const MoveChapterReplyDTO &lhs, const MoveChapterReplyDTO &rhs)
{
    ...
    return 
            lhs.m_originBookId == rhs.m_originBookId  && lhs.m_targetedChapterId == rhs.m_targetedChapterId  && lhs.m_scenePositionAtOrigin == rhs.m_scenePositionAtOrigin  && lhs.m_destinationChapterId == rhs.m_destinationChapterId  && lhs.m_scenePositionAtDestination == rhs.m_scenePositionAtDestination 
    ;
}
