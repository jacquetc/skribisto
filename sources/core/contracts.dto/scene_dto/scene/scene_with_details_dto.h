...
public:
    ...
    SceneWithDetailsDTO() : m_id(0), m_uuid(QUuid()), m_creationDate(QDateTime()), m_updateDate(QDateTime()), m_title(
            QString())
    {}
    ...
    SceneWithDetailsDTO(const SceneWithDetailsDTO& other) : m_id(other.m_id), m_uuid(other.m_uuid), m_creationDate(
    ...
    friend bool operator==(const SceneWithDetailsDTO& lhs,
                           const SceneWithDetailsDTO& rhs);


    friend uint qHash(const SceneWithDetailsDTO& dto,
                      uint                       seed) noexcept;
...
Q_DECLARE_METATYPE(Contracts::DTO::Scene::SceneWithDetailsDTO)
