...
public:
    ...
    UpdateChapterDTO() : m_id(0), m_uuid(QUuid()), m_creationDate(QDateTime()), m_updateDate(QDateTime()), m_title(
            QString())
    {}
    ...
    UpdateChapterDTO(const UpdateChapterDTO& other) : m_id(other.m_id), m_uuid(other.m_uuid), m_creationDate(
    ...
    friend bool operator==(const UpdateChapterDTO& lhs,
                           const UpdateChapterDTO& rhs);


    friend uint qHash(const UpdateChapterDTO& dto,
                      uint                    seed) noexcept;
