...
class CreateAuthorDTO
{
  ...
  public:
    ...
    CreateAuthorDTO(const CreateAuthorDTO &other) : m_uuid(other.m_uuid), m_creationDate(other.m_creationDate), m_updateDate(other.m_updateDate), m_name(other.m_name)
    {
    }
