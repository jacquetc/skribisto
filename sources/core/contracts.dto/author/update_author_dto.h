...
class UpdateAuthorDTO
{
  ...
  public:
    UpdateAuthorDTO() : m_id(0), m_uuid(QUuid()), m_creationDate(QDateTime()), m_updateDate(QDateTime()), m_name(QString())
    {
    }
    ...
    UpdateAuthorDTO( int id,   const QUuid &uuid,   const QDateTime &creationDate,   const QDateTime &updateDate,   const QString &name ) 
        : m_id(id), m_uuid(uuid), m_creationDate(creationDate), m_updateDate(updateDate), m_name(name)
    {
    }

    UpdateAuthorDTO(const UpdateAuthorDTO &other) : m_id(other.m_id), m_uuid(other.m_uuid), m_creationDate(other.m_creationDate), m_updateDate(other.m_updateDate), m_name(other.m_name)
    {
    }
    ...
    friend bool operator==(const UpdateAuthorDTO &lhs, const UpdateAuthorDTO &rhs);


    friend uint qHash(const UpdateAuthorDTO &dto, uint seed) noexcept;
