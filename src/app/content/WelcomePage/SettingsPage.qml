...
SettingsPageForm {
    ...
    ListModel {
        ...
        ListElement {
            ...
            iconSource: "../icons/3rdparty/backup/accessibility.svg"
            qmlUrl: "SettingsPanels/AccessibilityPanel.qml"
        }
        ListElement {
            name: "appearance"
            buttonText: qsTr("Appearance")
            iconSource: "../icons/3rdparty/backup/folder-pictures.svg"
            qmlUrl: "SettingsPanels/AppearancePanel.qml"
        }

        ListElement {
            name: "save"
            buttonText: qsTr("Save")
            iconSource: "../icons/3rdparty/backup/document-save.svg"
            qmlUrl: "SettingsPanels/SavePanel.qml"
        }

        ListElement {
            name: "backup"
            buttonText: qsTr("Backup")
            iconSource: "../icons/3rdparty/backup/tools-media-optical-burn-image.svg"
            qmlUrl: "SettingsPanels/BackupPanel.qml"
        }
        ListElement {
            name: "ePaper"
            buttonText: qsTr("E-Paper")
            iconSource: "../icons/3rdparty/backup/smartphone.svg"
            qmlUrl: "SettingsPanels/EPaperPanel.qml"
        }
    }
    ...
    function loadFontFamily() {
        ...
        if (index === -1) {
            index = fontFamilyComboBox.find(skrRootItem.defaultFontFamily(),
                                            Qt.MatchContains)
        }
    ...
    checkSpellingComboBox.onCurrentValueChanged: {
        if (checkSpellingComboBox.activeFocus) {
            SkrSettings.spellCheckingSettings.spellCheckingLangCode
                    = checkSpellingComboBox.currentValue
        }
    }
