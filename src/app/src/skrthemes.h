...
class SKRThemes : public QObject
{
    ...
    Q_PROPERTY(QString distractionFree_mainTextAreaBackground MEMBER m_distractionFree_mainTextAreaBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString mainTextAreaForeground MEMBER m_mainTextAreaForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_mainTextAreaForeground MEMBER m_distractionFree_mainTextAreaForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString secondaryTextAreaBackground MEMBER m_secondaryTextAreaBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_secondaryTextAreaBackground MEMBER m_distractionFree_secondaryTextAreaBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString secondaryTextAreaForeground MEMBER m_secondaryTextAreaForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_secondaryTextAreaForeground MEMBER m_distractionFree_secondaryTextAreaForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString pageBackground MEMBER m_pageBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_pageBackground MEMBER m_distractionFree_pageBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString buttonBackground MEMBER m_buttonBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_buttonBackground MEMBER m_distractionFree_buttonBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString buttonForeground MEMBER m_buttonForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_buttonForeground MEMBER m_distractionFree_buttonForeground NOTIFY colorsChanged)
    Q_PROPERTY(QString buttonIcon MEMBER m_buttonIcon NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_buttonIcon MEMBER m_distractionFree_buttonIcon NOTIFY colorsChanged)
    Q_PROPERTY(QString accent MEMBER m_accent NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_accent MEMBER m_distractionFree_accent NOTIFY colorsChanged)
    Q_PROPERTY(QString spellcheck MEMBER m_spellcheck NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_spellcheck MEMBER m_distractionFree_spellcheck NOTIFY colorsChanged)
    Q_PROPERTY(QString toolBarBackground MEMBER m_toolBarBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_toolBarBackground MEMBER m_distractionFree_toolBarBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString divider MEMBER m_divider NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_divider MEMBER m_distractionFree_divider NOTIFY colorsChanged)
    Q_PROPERTY(QString menuBackground MEMBER m_menuBackground NOTIFY colorsChanged)
    Q_PROPERTY(QString distractionFree_menuBackground MEMBER m_distractionFree_menuBackground NOTIFY colorsChanged)
...
public:
    ...
    Q_INVOKABLE bool duplicate(const QString &themeName, const QString &newThemeName);
