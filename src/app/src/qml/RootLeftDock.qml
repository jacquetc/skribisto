...
RootLeftDockForm {
    ...
    // fold :
    property bool folded: SkrSettings.rootSettings.leftDockFolded
    onFoldedChanged: folded ? fold() : unfold()

    function fold() {
        state = "dockFolded"
        SkrSettings.rootSettings.leftDockFolded = true
        folded = true
    }
    function unfold() {
        state = "dockUnfolded"
        SkrSettings.rootSettings.leftDockFolded = false
        folded = false
    }
    ...
    fixedWidth: SkrSettings.rootSettings.leftDockWidth
    ...
    Component.onDestruction: {
        ...
        SkrSettings.rootSettings.leftDockFolded = folded
    }
}
