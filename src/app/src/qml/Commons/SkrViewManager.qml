...
Item {
    ...
    function openBottomLeftView() {
        loader_bottom_left.setSource("qrc:///eu.skribisto.skribisto/qml/EmptyPage.qml", {"position": Qt.BottomLeftCorner, "viewManager": viewManager})
    ...
    function openTopRightView() {
        loader_top_right.setSource("qrc:///eu.skribisto.skribisto/qml/EmptyPage.qml", {"position": Qt.TopRightCorner, "viewManager": viewManager})
    ...
    function openBottomRightView() {
        loader_bottom_right.setSource("qrc:///eu.skribisto.skribisto/qml/EmptyPage.qml", {"position": Qt.BottomRightCorner, "viewManager": viewManager})
    ...
    function restoreViewsFromSettings() {
        ...
        //size :
        var topLeftViewSize = skrUserSettings.getSetting(windowGroup, "topLeftViewSize", verticalMiddle)
        var topRightViewSize = skrUserSettings.getSetting(windowGroup, "topRightViewSize", verticalMiddle)
        var leftSplitViewSize = skrUserSettings.getSetting(windowGroup, "leftSplitViewSize", horizontalMiddle)


        //visible :
        var bottomLeftViewVisible = skrUserSettings.getSetting(windowGroup, "bottomLeftViewVisible", false)
        var topRightViewVisible = skrUserSettings.getSetting(windowGroup, "topRightViewVisible", false)
        var bottomRightViewVisible = skrUserSettings.getSetting(windowGroup, "bottomRightViewVisible", false)
    ...
    function saveViewsToSettings() {
        ...
        if(loader_bottom_left.visible){
            skrUserSettings.setSetting(windowGroup, "bottomLeftViewVisible", loader_bottom_left.visible)
            skrUserSettings.setSetting(windowGroup, "topLeftViewSize", loader_top_left.height)
        }
        if(loader_top_right.visible){
            skrUserSettings.setSetting(windowGroup, "topRightViewVisible", loader_top_right.visible)
            skrUserSettings.setSetting(windowGroup, "leftSplitViewSize", leftVerticalSplitView.width)
        }
        if(loader_bottom_right.visible){
            skrUserSettings.setSetting(windowGroup, "bottomRightViewVisible", loader_top_right.visible)
            skrUserSettings.setSetting(windowGroup, "topRightViewSize", loader_top_right.height)
    ...
    function restoreProjectOpenedItems(projectId){
        ...
        var keyPrefix = "window_" + skrWindowManager.getWindowId(rootWindow) + "_"


        var topLeftTreeId = skrUserSettings.getFromProjectSettingHash(projectId, "openedItems", keyPrefix + "top_left", -2)
        var topRightTreeId = skrUserSettings.getFromProjectSettingHash(projectId, "openedItems", keyPrefix + "top_right", -2)
        var bottomLeftTreeId = skrUserSettings.getFromProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_left", -2)
        var bottomRightTreeId = skrUserSettings.getFromProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_right", -2)

        var top_left_additionalProperties = skrUserSettings.getFromProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "top_left", -2)
        var top_right_additionalProperties = skrUserSettings.getFromProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "top_right", -2)
        var bottom_left_additionalProperties = skrUserSettings.getFromProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "bottom_left", -2)
        var bottom_right_additionalProperties = skrUserSettings.getFromProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "bottom_right", -2)
    ...
    function saveProjectOpenedItems(projectId){
        ...
        //reset
        skrUserSettings.removeFromProjectSettingHash(projectId, "openedItems", keyPrefix + "top_left")
        skrUserSettings.removeFromProjectSettingHash(projectId, "openedItems", keyPrefix + "top_right")
        skrUserSettings.removeFromProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_left")
        skrUserSettings.removeFromProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_right")
        ...
        skrUserSettings.insertInProjectSettingHash(projectId, "openedItems", keyPrefix + "top_left", top_left_treeItemId)
        skrUserSettings.insertInProjectSettingHash(projectId, "openedItems", keyPrefix + "top_right", top_right_treeItemId)
        skrUserSettings.insertInProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_left", bottom_left_treeItemId)
        skrUserSettings.insertInProjectSettingHash(projectId, "openedItems", keyPrefix + "bottom_right", bottom_right_treeItemId)

        skrUserSettings.insertInProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "top_left", top_left_additionalProperties)
        skrUserSettings.insertInProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "top_right", top_right_additionalProperties)
        skrUserSettings.insertInProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "bottom_left", bottom_left_additionalProperties)
        skrUserSettings.insertInProjectSettingHash(projectId, "additionalPropertiesForSavingView", keyPrefix + "bottom_right", bottom_right_additionalProperties)
    ...
    function loadTreeItemAt(projectId, treeItemId, position){
        ...
        var properties = {"position": position, "viewManager": viewManager, "projectId": projectId,
            "treeItemId": treeItemId, "pageType": pageType}
    ...
    function loadProjectIndependantPageAt(pageType, position){
        ...
        var properties = {"position": position, "viewManager": viewManager, "projectId": -1,
    ...
    function closePagesWithTreeItemId(projectId, treeItemId){
        ...
        for(i = 0; i < allPositions.length; i++){
            ...
            if(loader.visible){
                if(loader.item){
                    if(loader.item.projectId === projectId && loader.item.treeItemId === treeItemId){
                        loadProjectIndependantPageAt("EMPTY", allPositions[i])
                    }
                }
            }
