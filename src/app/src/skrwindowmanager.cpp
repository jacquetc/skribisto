...
SKRWindowManager::SKRWindowManager(QObject *parent, QQmlApplicationEngine *engine, const QUrl &mainUrl) : QObject(parent), m_engine(engine), m_url(mainUrl)
{
...
void SKRWindowManager::addWindow(int projectId, int treeItemId, const QString &pageType)
{
    ...
    QVariantMap propertiesMap = {{"x", x},{"y", y},{"width", width},{"height", height}, {"visibility", visibility},
                              {"projectIdToBeLoaded", projectId},{"treeItemIdToBeLoaded", treeItemId},
                              {"projectIndependantPageTypeToBeLoaded", pageType},
                              {"windowId", nextFreeWindowId}};
