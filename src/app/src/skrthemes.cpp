...
void SKRThemes::populate()
{
    ...
    for (const QString &path : paths){
        ...
        for(const QFileInfo &entryInfo : entries){
            ...
            QString themeName = jsonObject.value("themeName").toString("Missing theme name");
...
void SKRThemes::applyTheme(const QString &themeName)
{
    ...
    if(jsonError.error != QJsonParseError::NoError){
        qDebug() << "Error JSON in theme" << m_fileByThemeNameHash.value(theme) << "error :" << jsonError.errorString();
    }
    ...
    m_mainTextAreaBackground = normalObject.value("mainTextAreaBackground").toString("").toLower();
    m_mainTextAreaForeground =  normalObject.value("mainTextAreaForeground").toString("").toLower();
    m_secondaryTextAreaBackground =  normalObject.value("secondaryTextAreaBackground").toString("").toLower();
    m_secondaryTextAreaForeground =  normalObject.value("secondaryTextAreaForeground").toString("").toLower();
    m_pageBackground =  normalObject.value("pageBackground").toString("").toLower();
    m_buttonBackground =  normalObject.value("buttonBackground").toString("").toLower();
    m_buttonForeground =  normalObject.value("buttonForeground").toString("").toLower();
    m_buttonIcon =  normalObject.value("buttonIcon").toString("").toLower();
    m_accent =  normalObject.value("accent").toString("").toLower();
    m_spellcheck =  normalObject.value("spellcheck").toString("").toLower();
    m_toolBarBackground =  normalObject.value("toolBarBackground").toString("").toLower();
    m_divider =  normalObject.value("divider").toString("").toLower();
    m_menuBackground =  normalObject.value("menuBackground").toString("").toLower();

    QJsonObject distractionFreeObject = rootJsonObject.value("distractionFree").toObject();

    m_distractionFree_mainTextAreaBackground = distractionFreeObject.value("mainTextAreaBackground").toString("").toLower();
    m_distractionFree_mainTextAreaForeground =  distractionFreeObject.value("mainTextAreaForeground").toString("").toLower();
    m_distractionFree_secondaryTextAreaBackground =  distractionFreeObject.value("secondaryTextAreaBackground").toString("").toLower();
    m_distractionFree_secondaryTextAreaForeground =  distractionFreeObject.value("secondaryTextAreaForeground").toString("").toLower();
    m_distractionFree_pageBackground =  distractionFreeObject.value("pageBackground").toString("").toLower();
    m_distractionFree_buttonBackground =  distractionFreeObject.value("buttonBackground").toString("").toLower();
    m_distractionFree_buttonForeground =  distractionFreeObject.value("buttonForeground").toString("").toLower();
    m_distractionFree_buttonIcon =  distractionFreeObject.value("buttonIcon").toString("").toLower();
    m_distractionFree_accent =  distractionFreeObject.value("accent").toString("").toLower();
    m_distractionFree_spellcheck =  distractionFreeObject.value("spellcheck").toString("").toLower();
    m_distractionFree_toolBarBackground =  distractionFreeObject.value("toolBarBackground").toString("").toLower();
    m_distractionFree_divider =  distractionFreeObject.value("divider").toString("").toLower();
    m_distractionFree_menuBackground =  distractionFreeObject.value("menuBackground").toString("").toLower();
...
void SKRThemes::saveTheme(const QString &themeName){
    ...
    distractionFreeObject.insert("mainTextAreaBackground", m_distractionFree_mainTextAreaBackground);
    distractionFreeObject.insert("mainTextAreaForeground", m_distractionFree_mainTextAreaForeground);
    distractionFreeObject.insert("secondaryTextAreaBackground", m_distractionFree_secondaryTextAreaBackground);
    distractionFreeObject.insert("secondaryTextAreaForeground", m_distractionFree_secondaryTextAreaForeground);
    distractionFreeObject.insert("pageBackground", m_distractionFree_pageBackground);
    distractionFreeObject.insert("buttonBackground", m_distractionFree_buttonBackground);
    distractionFreeObject.insert("buttonForeground", m_distractionFree_buttonForeground);
    ...
    distractionFreeObject.insert("spellcheck", m_distractionFree_spellcheck);
    distractionFreeObject.insert("toolBarBackground", m_distractionFree_toolBarBackground);
    distractionFreeObject.insert("divider", m_distractionFree_divider);
    distractionFreeObject.insert("menuBackground", m_distractionFree_menuBackground);
