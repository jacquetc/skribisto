...
class EXPORT SKRSearchTagListProxyModel : public QSortFilterProxyModel {
    ...
    Q_PROPERTY(
        QList<int>hideTagIdListFilter MEMBER m_hideTagIdListFilter WRITE setHideTagIdListFilter NOTIFY hideTagIdListFilterChanged)
...
private:
    ...
    SKRTagItem* getItem(int projectId,
                        int tagId);
