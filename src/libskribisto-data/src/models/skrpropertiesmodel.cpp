...
// QVariant SKRPropertiesModel::headerData(int section, Qt::Orientation
// orientation,
//                                        int role) const
// {
//    // FIXME: Implement me!
...
// bool SKRPropertiesModel::setData(const QModelIndex& index, const QVariant&
// value,
//                                 int role)
// {
...
// bool SKRPropertiesModel::insertRows(int row, int count, const QModelIndex&
// parent)
// {
...
// bool SKRPropertiesModel::insertColumns(int column, int count, const
// QModelIndex& parent)
// {
...
// bool SKRPropertiesModel::removeRows(int row, int count, const QModelIndex&
// parent)
// {
...
// bool SKRPropertiesModel::removeColumns(int column, int count, const
// QModelIndex& parent)
// {
