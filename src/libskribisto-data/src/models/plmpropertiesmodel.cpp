...
QVariant PLMPropertiesModel::headerData(int section, Qt::Orientation orientation,
                                        int role) const
{
    // FIXME: Implement me!
}

bool PLMPropertiesModel::setHeaderData(int             section,
...
QModelIndex PLMPropertiesModel::index(int row, int column,
...
bool PLMPropertiesModel::setData(const QModelIndex& index, const QVariant& value,
                                 int role)
{
