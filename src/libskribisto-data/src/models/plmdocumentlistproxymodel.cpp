...
PLMDocumentListProxyModel::PLMDocumentListProxyModel(QObject *parent) :
...
bool PLMDocumentListProxyModel::filterAcceptsRow(int                source_row,
                                                 const QModelIndex& source_parent) const
{
    ...
    int indexSubWindowId = sourceModel()->data(index,
                                               PLMDocumentListModel::Roles::SubWindowRole)
                           .toInt();

    qDebug() << indexSubWindowId << m_subWindowId;

    if (indexSubWindowId == m_subWindowId) return true;
...
QVariant PLMDocumentListProxyModel::data(const QModelIndex& index, int role) const
{
    ...
    // PLMDocumentListModel::Roles::NameRole);
    //    }
