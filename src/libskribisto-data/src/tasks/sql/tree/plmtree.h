...
public:
    ...
    explicit PLMTree(QObject       *parent,
    ...
    void                            setContent(int             paperId,
                                               const QVariant& value);
    QString                         getTitle(int paperId) const;
    void                            setTitle(int            paperId,
                                             const QString& value);
    QList<int>                      addNewChildPapers(int parentId,
                                                      int number);
    QList<int>                      addNewPapersBy(int paperId,
                                                   int number);
    void                            movePapersAsChildOf(QList<int>paperIdList,
                                                        int       destId);
    void                            movePapersAbove(QList<int>paperIdList,
                                                    int       destId);
    ...
    void                            setUpdateDate(int              paperId,
                                                  const QDateTime& value);
    QDateTime                       getContentDate(int paperId) const;
    void                            setContentDate(int              paperId,
                                                   const QDateTime& value);
