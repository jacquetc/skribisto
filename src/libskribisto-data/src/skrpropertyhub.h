...
public:
    ...
    Q_INVOKABLE SKRResult setProperty(int            projectId,
                                     int            treeItemCode,
                                     const QString& name,
                                     const QString& value, bool isSystem = false, bool isSilent = false, bool triggerProjectModifiedSignal = true);
    int      getLastAddedId();
    ...
    QString            getPropertyById(int projectId,
                                       int propertyId) const;
    int getPropertyId(int projectId, int treeItemCode, const QString &name) const;
