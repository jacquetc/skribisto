...
class SKRIBISTO_CONTRACTS_EXPORT InterfaceRecentAtelierRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<Skribisto::Domain::RecentAtelier>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
  public:
    virtual ~InterfaceRecentAtelierRepository()
    {
    }
