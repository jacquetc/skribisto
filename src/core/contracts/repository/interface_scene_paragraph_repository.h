...
class SKRIBISTO_CONTRACTS_EXPORT InterfaceSceneParagraphRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<Skribisto::Domain::SceneParagraph>,
