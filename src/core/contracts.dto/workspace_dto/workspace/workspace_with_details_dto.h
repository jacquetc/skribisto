...
class WorkspaceWithDetailsDTO
{
  ...
  public:
    ...
    WorkspaceWithDetailsDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate,
    ...
    WorkspaceWithDetailsDTO(const WorkspaceWithDetailsDTO &other)
    ...
    WorkspaceWithDetailsDTO &operator=(const WorkspaceWithDetailsDTO &other)
    {
        if (this != &other)
        {
    ...
    WorkspaceWithDetailsDTO &mergeWith(const WorkspaceWithDetailsDTO &other)
    {
        if (this != &other)
        {
    ...
    friend bool operator==(const WorkspaceWithDetailsDTO &lhs, const WorkspaceWithDetailsDTO &rhs);

    friend uint qHash(const WorkspaceWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const WorkspaceWithDetailsDTO &lhs, const WorkspaceWithDetailsDTO &rhs)
{
...
inline uint qHash(const WorkspaceWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(Skribisto::Contracts::DTO::Workspace::WorkspaceWithDetailsDTO)