...
class UpdateSceneDTO
{
  ...
  public:
    ...
    UpdateSceneDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate,
    ...
    UpdateSceneDTO(const UpdateSceneDTO &other)
    ...
    UpdateSceneDTO &mergeWith(const UpdateSceneDTO &other)
    {
        if (this != &other)
        {
...
Q_DECLARE_METATYPE(Skribisto::Contracts::DTO::Scene::UpdateSceneDTO)