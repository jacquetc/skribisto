...
class BookWithDetailsDTO
{
  ...
  public:
    ...
    BookWithDetailsDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate,
    ...
    BookWithDetailsDTO(const BookWithDetailsDTO &other)
    ...
    BookWithDetailsDTO &operator=(const BookWithDetailsDTO &other)
    {
        if (this != &other)
        {
    ...
    BookWithDetailsDTO &mergeWith(const BookWithDetailsDTO &other)
    {
        if (this != &other)
        {
    ...
    friend bool operator==(const BookWithDetailsDTO &lhs, const BookWithDetailsDTO &rhs);

    friend uint qHash(const BookWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const BookWithDetailsDTO &lhs, const BookWithDetailsDTO &rhs)
{
...
inline uint qHash(const BookWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(Skribisto::Contracts::DTO::Book::BookWithDetailsDTO)