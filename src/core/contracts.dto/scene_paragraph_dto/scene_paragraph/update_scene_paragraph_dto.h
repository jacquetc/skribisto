...
class UpdateSceneParagraphDTO
{
  ...
  public:
    ...
    UpdateSceneParagraphDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate,
    ...
    UpdateSceneParagraphDTO &mergeWith(const UpdateSceneParagraphDTO &other)
    {
        if (this != &other)
        {
...
Q_DECLARE_METATYPE(Skribisto::Contracts::DTO::SceneParagraph::UpdateSceneParagraphDTO)