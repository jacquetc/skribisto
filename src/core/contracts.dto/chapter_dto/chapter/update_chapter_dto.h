...
class UpdateChapterDTO
{
  ...
  public:
    ...
    UpdateChapterDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate,
    ...
    UpdateChapterDTO(const UpdateChapterDTO &other)
    ...
    UpdateChapterDTO &mergeWith(const UpdateChapterDTO &other)
    {
        if (this != &other)
        {
...
Q_DECLARE_METATYPE(Skribisto::Contracts::DTO::Chapter::UpdateChapterDTO)