...
{
class SKRIBISTO_APPLICATION_SYSTEM_EXPORT LoadAtelierCommandHandler : public QObject
{
    Q_OBJECT
  public:
    LoadAtelierCommandHandler(InterfaceRecentAtelierRepository *recentAtelierRepository,
    ...
    Result<void> handle(QPromise<Result<void>> &progressPromise, const LoadAtelierCommand &request);
  ...
  private:
    ...
    Result<void> handleImpl(QPromise<Result<void>> &progressPromise, const LoadAtelierCommand &request);
