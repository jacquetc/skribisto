...
{
class SKRIBISTO_APPLICATION_SYSTEM_EXPORT CreateNewAtelierCommandHandler : public QObject
{
    Q_OBJECT
  public:
    CreateNewAtelierCommandHandler(InterfaceRecentAtelierRepository *recentAtelierRepository,
    ...
    Result<void> handle(QPromise<Result<void>> &progressPromise, const CreateNewAtelierCommand &request);
  ...
  private:
    ...
    Result<void> handleImpl(QPromise<Result<void>> &progressPromise, const CreateNewAtelierCommand &request);
