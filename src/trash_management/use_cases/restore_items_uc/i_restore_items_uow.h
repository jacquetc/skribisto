...
class IRestoreItemsUnitOfWork : public virtual Common::UnitOfWork::ITransactional
{
  public:
    ~IRestoreItemsUnitOfWork() override = default;
    ...
    virtual void publishRestoreItemsSignal() = 0;
};
} // namespace Skribisto::TrashManagement
