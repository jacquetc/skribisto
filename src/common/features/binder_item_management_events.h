...
{
class BinderItemManagementEvents : public QObject
{
    Q_OBJECT
  public:
    explicit BinderItemManagementEvents(QObject *parent = nullptr) : QObject(parent)
    {
  ...
  public Q_SLOTS:
    ...
    void publishDuplicateSignal()
    {
        Q_EMIT duplicateSignal();
    }

    void publishMoveItemsSignal()
    {
        Q_EMIT moveItemsSignal();
    }
