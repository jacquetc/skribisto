...
QHash<int, QList<int>> UnorderedOneToMany::getRightIdsMany(QSqlDatabase &db, const QList<int> &leftIds,
...
QList<int> UnorderedOneToMany::getRightIds(QSqlDatabase &db, int leftId, const QString &junctionTableName)
{
...
QHash<int, bool> UnorderedOneToMany::removeWithLeftIdsMany(QSqlDatabase &db, const QList<int> &leftIds,
                                                           const QString &junctionTableName)
{
...
bool UnorderedOneToMany::removeWithLeftIds(QSqlDatabase &db, int leftId, const QString &junctionTableName)
{
    QHash<int, bool> result = removeWithLeftIdsMany(db, {leftId}, junctionTableName);
    return result.value(leftId, false);
}

QHash<int, bool> UnorderedOneToMany::removeWithRightIdsMany(QSqlDatabase &db, const QList<int> &rightIds,
                                                            const QString &junctionTableName)
{
    QHash<int, bool> result;
...
bool UnorderedOneToMany::removeWithRightIds(QSqlDatabase &db, int rightId, const QString &junctionTableName)
{
    QHash<int, bool> result = removeWithRightIdsMany(db, {rightId}, junctionTableName);
    return result.value(rightId, false);
}

QHash<int, QList<int>> UnorderedOneToMany::upsertRightIdsMany(QSqlDatabase &db,
...
QList<int> UnorderedOneToMany::upsertRightIds(QSqlDatabase &db, int leftId, const QString &junctionTableName,
...
QMap<int, int> UnorderedOneToMany::getLeftIdMany(QSqlDatabase &db, const QString &junctionTableName,
                                                 const QList<int> &rightIds)
{
    QMap<int, int> result;
...
int UnorderedOneToMany::getLeftId(QSqlDatabase &db, const QString &junctionTableName, int rightId)
{
    QMap<int, int> result = getLeftIdMany(db, junctionTableName, {rightId});
    return result.value(rightId, -1);
}

int UnorderedOneToMany::getRightIdsCount(QSqlDatabase &db, int leftId, const QString &junctionTableName)
{
    int cachedResult;
...
QList<int> UnorderedOneToMany::getRightIdsInRange(QSqlDatabase &db, int leftId, const QString &junctionTableName,
