...
class ServiceLocator : public QObject
{
  ...
  public:
    ...
    void setUndoRedoSystem(UndoRedo::ThreadedUndoRedoSystem *urs);
    ...
    QPointer<UndoRedo::ThreadedUndoRedoSystem> undoRedoSystem() const;
  ...
  private:
    ...
    QPointer<UndoRedo::ThreadedUndoRedoSystem> m_undoRedoSystem;
};
