...
class IRootTable
{
  public:
    ...
    virtual QList<SCE::Root> updateWithRelationshipsMany(const QList<SCE::Root> &roots) = 0;
...
class RootRepository : public IRootRepository
{
  public:
    ...
    QList<SCE::Root> updateWithRelationships(const QList<SCE::Root> &roots) override;
