...
class IContentTable
{
  public:
    ...
    virtual QList<SCE::Content> updateWithRelationshipsMany(const QList<SCE::Content> &contents) = 0;
...
class ContentRepository : public IContentRepository
{
  public:
    ...
    QList<SCE::Content> updateWithRelationships(const QList<SCE::Content> &contents) override;
