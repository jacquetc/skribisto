...
inline QList<QString> getSqlJunctionTableDefinitions()
{
    ...
    definitions << QStringLiteral("CREATE TABLE IF NOT EXISTS project_binders_to_binder_junction ("
    ...
    definitions << QStringLiteral("CREATE TABLE IF NOT EXISTS project_author_to_author_junction ("
                                  "    left_id INTEGER NOT NULL,"
                                  "    right_id INTEGER NOT NULL,"
                                  "    PRIMARY KEY (left_id, right_id)"
                                  ");");
    ...
    definitions << QStringLiteral("CREATE TABLE IF NOT EXISTS project_tags_to_tag_junction ("
                                  "    left_id INTEGER NOT NULL,"
                                  "    right_id INTEGER NOT NULL,"
                                  "    PRIMARY KEY (left_id, right_id)"
                                  ");");
