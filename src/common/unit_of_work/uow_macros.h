// Generated by Qleany v1.6.1 from uow_macros_h.tera
/******************************************************************************
...
#define DECLARE_UOW_ENTITY_UPDATE_WITH_RELATIONSHIPS(Name)                                                             \
    [[nodiscard]] virtual QList<SCE::Name> updateWithRelationships##Name(const QList<SCE::Name> &items) = 0
...
#define DECLARE_UOW_ENTITY_CRUD(Name)                                                                                  \
    ...
    DECLARE_UOW_ENTITY_UPDATE_WITH_RELATIONSHIPS(Name);                                                                \
...
#define UOW_ENTITY_UPDATE_WITH_RELATIONSHIPS(Name)                                                                     \
  public:                                                                                                              \
    [[nodiscard]] QList<SCE::Name> updateWithRelationships##Name(const QList<SCE::Name> &items) override               \
    {                                                                                                                  \
        auto repo = SCD::RepositoryFactory::create##Name##Repository(m_dbSubContext, m_eventRegistry, m_signalBuffer); \
...
#define UOW_ENTITY_CRUD(Name)                                                                                          \
    ...
    UOW_ENTITY_UPDATE_WITH_RELATIONSHIPS(Name)                                                                         \
