// Generated by Qleany v1.4.2 from unit_of_work_h.tera
/******************************************************************************
 ...
 *   Interface: DECLARE_UOW_ENTITY_{CREATE,CREATE_ORPHANS,GET_REL_FROM_OWNER,SET_REL_IN_OWNER,GET,UPDATE,REMOVE}(Name)
 *                 DECLARE_UOW_ENTITY_CRUD(Name)
 *                 DECLARE_UOW_ORPHAN_ENTITY_CRUD(Name)
 *                 DECLARE_UOW_ENTITY_RELATIONSHIPS(Name, Rel)
 *   Implementation: UOW_ENTITY_{CREATE,CREATE_ORPHANS,GET_REL_FROM_OWNER,SET_REL_IN_OWNER,GET,UPDATE,REMOVE}(Name)
