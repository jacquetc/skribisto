// Generated by Qleany v1.6.1 from uow_ops_h.tera
/******************************************************************************
...
template <typename EntityType> class IEntityCrud : public virtual ITransactional
{
  public:
    ...
    [[nodiscard]] virtual QList<EntityType> updateWithRelationships(const QList<EntityType> &items) = 0;
...
template <typename Derived, typename EntityType> class EntityCrudImpl : public virtual IEntityCrud<EntityType>
{
  public:
    ...
    [[nodiscard]] QList<EntityType> updateWithRelationships(const QList<EntityType> &items) override
    {
        auto repo = self().makeRepository();
        return repo->updateWithRelationships(items);
    }
