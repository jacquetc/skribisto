...
class UiConverter:
    def __init__(self):
        ...
        if _df and os.path.exists(_df):
            self.build_forms(_df)

    def find_forms(self, srcdir):
    ...
    def form_to_compiled_form(self, form):
        return form.rpartition('.')[0] + '_ui.py'


    def build_forms(self, srcdir, info=None, summary=False):
        import re
