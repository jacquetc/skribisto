...
class TreeSheet(QObject):
    ...
    def load(self):
        ...
        self._content = cfg.data.database.sheet_tree.get_content(self.sheet_id)
        self._title = cfg.data.database.sheet_tree.get_title(self.sheet_id)
        #self._content_type = cfg.data.database.sheet_tree.get_content_type(self.sheet_id)
        self._properties = cfg.data.database.sheet_tree.get_properties(self.sheet_id)
        self._last_modification_date = cfg.data.database.sheet_tree.get_modification_date(
            self.sheet_id)
        self._creation_date = cfg.data.database.sheet_tree.get_creation_date(
            self.sheet_id)
        self._version = cfg.data.database.sheet_tree.get_version(self.sheet_id)
    ...
    def get_title(self):
        return cfg.data.database.sheet_tree.get_title(self.sheet_id)

    def set_title(self, new_title):
        cfg.data.database.sheet_tree.set_title(self.sheet_id, new_title)
    ...
    def get_content(self):
        ...
        '''
        content = cfg.data.database.sheet_tree.get_content(self.sheet_id)
        return content
    ...
    def set_content(self, content):
        ...
        cfg.data.database.sheet_tree.set_content(self.sheet_id, content)
    ...
    def get_modification_date(self):
        ...
        '''
        modification_date = cfg.data.database.sheet_tree.get_modification_date(
            self.sheet_id)
    ...
    def get_creation_date(self):
        ...
        '''
        creation_date = cfg.data.database.sheet_tree.get_creation_date(self.sheet_id)
    ...
    def get_version(self):
        ...
        '''
        version = cfg.data.database.sheet_tree.get_version(self.sheet_id)
        return version
...
class StoryTreeSheet(TreeSheet):
    ...
    def set_synopsys(self, content):
        ...
        cfg.data.database.sheet_tree.set_other_contents(self.sheetid, other_contents)
