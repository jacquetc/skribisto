...
struct ForeignRecentWorkController : public QObject
{
  ...
  public:
    ...
    Q_INVOKABLE static Skribisto::DirectAccess::RecentWork::UpdateRecentWorkDto getUpdateDto()
    {
        return Skribisto::DirectAccess::RecentWork::RecentWorkController::getUpdateDto();
    }

    Q_INVOKABLE static Skribisto::DirectAccess::RecentWork::UpdateRecentWorkDto toUpdateDto(
        const Skribisto::DirectAccess::RecentWork::RecentWorkDto &dto)
    {
        return Skribisto::DirectAccess::RecentWork::UpdateRecentWorkDto(dto);
    }

    Q_INVOKABLE QCoro::QmlTask update(const QList<Skribisto::DirectAccess::RecentWork::UpdateRecentWorkDto> &dtos) const
    {
        return m_controller->update(dtos);
    }

    Q_INVOKABLE QCoro::QmlTask updateWithRelationships(
        const QList<Skribisto::DirectAccess::RecentWork::RecentWorkDto> &dtos) const
    {
