...
TrashedListViewForm {
    ...
    trashProjectComboBox.displayText: qsTr("Trash: %1").arg(
                                          trashProjectComboBox.currentText)
    ...
    function populateProjectComboBoxModel() {
        ...
        if (projectList.length > 0) {
            ...
            var _projectId = trashProjectComboBox.valueAt(
