...
public:
    ...
    QString pageUrl() const override {
        return "qrc:///eu.skribisto.skribisto/imports/qml/plugins/skribisto-plugin-textPage/TextPage.qml";
    }
    ...
    QString settingsPanelQmlUrl() const override    {
        return "qrc:///eu.skribisto.skribisto/imports/qml/plugins/skribisto-plugin-textPage/Settings.qml";
    }
