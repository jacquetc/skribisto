...
//actionSave->setShortcut(QApplication::translate("WritePanel", "Ctrl+S", 0));
//menuBar->addActionToMenu(actionSave, MenuBar::Project, "actionSaveAll");

//connect(actionSave, SIGNAL(triggered()), this, SLOT(actionSave_triggered()));
...
//    actionView_Source->setText(QApplication::translate("WritePanel", "Source", 0));

//    connect(actionView_Source, SIGNAL(triggered(bool)), ui->mainTextWritingZone, SLOT(setSourceEditEnabled(bool)));
...
//    actionView_MiniMap->setText(QApplication::translate("WritePanel", "MiniMap", 0));

//    connect(actionView_MiniMap, SIGNAL(triggered(bool)), ui->mainTextWritingZone, SLOT(setMiniMapEnabled(bool)));
...
//  this->connect(actionAdd_Dock, SIGNAL(triggered()), dockManager, SLOT(addDock()), Qt::UniqueConnection);
