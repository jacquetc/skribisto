...
struct ProjectDto
{
  ...
  public:
    ...
    QList<int> binders = {};
    ProjectDto() = default;
    ProjectDto(const int id, const QDateTime &createdAt, const QDateTime &updatedAt, const QString &title,
...
struct CreateProjectDto
{
  ...
  public:
    ...
    QString dictLanguage;
    QList<int> binders = {};
    CreateProjectDto() = default;
    CreateProjectDto(const QDateTime &createdAt, const QDateTime &updatedAt, const QString &title,
                     const QString &dictLanguage, const QList<int> &binders)
