...
class DtoMapper final
{
  public:
    ...
    static SCE::BinderTag toEntity(const UpdateBinderTagDto &dto)
    {
        return SCE::BinderTag{
            .id = dto.id,
            .createdAt = dto.createdAt,
    ...
    static QList<SCE::BinderTag> toEntityList(const QList<UpdateBinderTagDto> &dtos)
    {
        QList<SCE::BinderTag> entities;
        entities.reserve(dtos.size());
        std::ranges::transform(dtos, std::back_inserter(entities),
                               [](const UpdateBinderTagDto &dto) { return toEntity(dto); });
        return entities;
    }
