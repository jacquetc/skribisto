...
class BinderTagController : public QObject
{
  ...
  public:
    ...
    static UpdateBinderTagDto getUpdateDto()
    {
        return {};
    }
    QCoro::Task<QList<BinderTagDto>> get(const QList<int> &binderTagIds) const;
    QCoro::Task<QList<BinderTagDto>> getAll() const;
    QCoro::Task<QList<BinderTagDto>> update(const QList<UpdateBinderTagDto> &binderTags);
    QCoro::Task<QList<BinderTagDto>> updateWithRelationships(const QList<BinderTagDto> &binderTags);
