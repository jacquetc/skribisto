...
class DtoMapper final
{
  public:
    ...
    static SCE::BinderItem toEntity(const UpdateBinderItemDto &dto)
    {
        return SCE::BinderItem{
            .id = dto.id,
            .createdAt = dto.createdAt,
    ...
    static QList<SCE::BinderItem> toEntityList(const QList<UpdateBinderItemDto> &dtos)
    {
        QList<SCE::BinderItem> entities;
        entities.reserve(dtos.size());
        std::ranges::transform(dtos, std::back_inserter(entities),
                               [](const UpdateBinderItemDto &dto) { return toEntity(dto); });
        return entities;
    }
