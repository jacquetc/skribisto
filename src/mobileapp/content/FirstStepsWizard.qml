...
SkrPopup {
    ...
    contentItem: SkrPane {
        ...
        ColumnLayout {
            ...
            SkrToolButton {
                ...
                icon {
                    source: "icons/backup/arrow-down.svg"
                }
            ...
            SwipeView {
                ...
                onCurrentIndexChanged: {
                    for (var i = 0; i < swipeView.count; i++) {
                        ...
                        swipeView.itemAt(
                                    i).enabled = i === swipeView.currentIndex
                    }
                }
                ...
                Item {
                    ColumnLayout {
                        ...
                        SkrLabel {
                            ...
                            text: "<h1>" + qsTr(
                                      "First steps with Skribisto") + "</h1>"
                        }

                        Image {
                            id: skribistoImage
                            Layout.alignment: Qt.AlignHCenter
                            source: "icons/skribisto.png"
                            ...
                            SkrComboBox {
                                ...
                                onCurrentValueChanged: {
                                    if (langComboBox.activeFocus) {
                                        skrRootItem.currentTranslationLanguageCode
                                                = langComboBox.currentValue
                                        skrWindowManager.retranslate()

                                        //skrData.errorHub().addOk(qsTr("Please restart Skribisto to apply the change"))
                                        checkSpellingComboBox.currentIndex
                                                = checkSpellingComboBox.indexOfValue(
                                                    langComboBox.currentValue)
                                    }
                                }
                            }
                            ...
                            SkrComboBox {
                                ...
                                onCurrentValueChanged: {
                                    if (checkSpellingComboBox.activeFocus) {
                                        SkrSettings.spellCheckingSettings.spellCheckingLangCode
                                                = langComboBox.currentValue
                                    }
                                }
                            }
                        ...
                        SkrSwitch {
                            ...
                            onCheckedChanged: {
                                SkrSettings.accessibilitySettings.showMenuButton
                                        = accessibilityCheckBox.checked
                            }
                        }
                        ...
                        SkrButton {
                            ...
                            onClicked: {
                                for (var i = 0; i < pluginsPage.pluginModel.count; i++) {
                                    ...
                                    skrData.pluginHub().setPluginEnabled(
                                                item.pluginName, item.enabled)
                                }
            ...
            RowLayout {
                ...
                SkrToolButton {
                    ...
                    icon {
                        ...
                        source: "icons/backup/go-previous.svg"
                    }
                ...
                SkrToolButton {
                    ...
                    icon {
                        height: 30 * SkrSettings.interfaceSettings.zoom
                        width: 30 * SkrSettings.interfaceSettings.zoom
                        source: "icons/backup/go-next.svg"
                    }
    ...
    function determineAvailableTranslations() {
        ...
        for (var translation in translationsMap) {
            langModel.append({
                                 "text": translationsMap[translation] + " (" + translation + ")",
                                 "langCode": translation
                             })
        }
    }
    function determineCurrentTranslation() {
        langComboBox.currentIndex = langComboBox.indexOfValue(
                    skrRootItem.getLanguageFromSettings())
    }
    ...
    function populateCheckSpellingComboBox() {
        ...
        for (i = 0; i < dictList.length; i++) {
            checkSpellingComboBoxModel.append({
                                                  "text": skrRootItem.getNativeLanguageNameFromLocale(
                                                              dictList[i]) + " ("
                                                          + dictList[i] + ")",
                                                  "dictCode": dictList[i]
                                              })
    ...
    Connections {
        ...
        function onSpellCheckingLangCodeChanged() {
            var value = SkrSettings.spellCheckingSettings.spellCheckingLangCode
            checkSpellingComboBox.currentIndex = checkSpellingComboBox.indexOfValue(
                        value)
        }
    }
}
