...
Item {
    ...
    function createDictFromPropertyName(attribute){
        ...
        case "printable":
            //inverted
            iconSource = "icons/3rdparty/backup/skribisto-document-print-none.svg"
            text = qsTr("Non printable")
            break;

        case "modifiable":
            //inverted
            iconSource = "icons/3rdparty/backup/lock.svg"
            text = qsTr("Locked")
            break;

        case "favorite":
            iconSource = "icons/3rdparty/backup/favorite.svg"
            text = qsTr("Favorite")
            break;
