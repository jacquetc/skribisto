...
Item {
    ...
    readonly property int sizePageLayoutHeight: sizePageLayout.childrenRect.height
                                                + sizePage.padding * 2
    readonly property int mainPageLayoutHeight: mainPageLayout.childrenRect.height
                                                + mainPage.padding * 2

    implicitHeight: sizePageLayoutHeight
                    > mainPageLayoutHeight ? sizePageLayoutHeight : mainPageLayoutHeight
