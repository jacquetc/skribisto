            ...
            SkrMenu {
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Return"
                        icon {
                            source: "icons/3rdparty/backup/document-edit.svg"
                        }
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Alt+Return"
                        icon {
                            source: "icons/3rdparty/backup/tab-new.svg"
                        }
                        enabled: openActionsEnabled
                                 && contextMenuItemIndex === model.index
                                 && titleTextField.visible === false
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "F2"
                        icon {
                            source: "icons/3rdparty/backup/edit-rename.svg"
                        }
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        icon {
                            source: "icons/3rdparty/backup/label.svg"
                        }
                        enabled: renameActionEnabled
                                 && contextMenuItemIndex === model.index
                                 && root.enabled
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Ctrl+Up"
                        icon {
                            source: "icons/3rdparty/backup/object-order-raise.svg"
                        }
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Ctrl+Down"
                        icon {
                            source: "icons/3rdparty/backup/object-order-lower.svg"
                        }
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Del"
                        icon {
                            source: "icons/3rdparty/backup/edit-delete.svg"
                        }
                ...
                SkrMenuItem {
                    ...
                    action: Action {
                        ...
                        //shortcut: "Del"
                        icon {
                            source: "icons/3rdparty/backup/edit-delete-shred.svg"
                        }
