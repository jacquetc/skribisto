...
def generate_application_files(manifest_file: str):
    pass
...
def get_files_to_be_generated(manifest_file: str) -> list[str]:
    ...
    common_cmake_folder_path = manifest["entities"]["common_cmake_folder_path"]
    ...
    files_to_be_generated.append(common_cmake_file)

    return files_to_be_generated


# generate the files into the preview folder
def preview_application_files(manifest_file: str):
