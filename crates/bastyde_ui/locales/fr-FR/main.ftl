...
pace-day-sat = Sam
pace-day-sun = Dim
pace-stat-words = { $current } mots sur { $goal }
pace-stat-percent = { $pct } % de l'objectif
pace-stat-no-goal = Aucun objectif de mots
pace-stat-streak = Série de { $days } jours d'écriture
pace-stat-streak-none = Aucune série en cours
pace-stat-days-left = Jours d'écriture restants : { $days }
pace-stat-rate = { $words } mots par jour requis
pace-stat-ahead = { $words } mots d'avance
pace-stat-behind = { $words } mots de retard
pace-stat-on-track = Pile dans les temps
pace-stat-no-deadline = Aucune échéance définie
