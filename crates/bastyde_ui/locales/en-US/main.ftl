...
pace-day-sat = Sat
pace-day-sun = Sun
pace-stat-words = { $current } of { $goal } words
pace-stat-percent = { $pct }% of the goal
pace-stat-no-goal = No word goal set
pace-stat-streak = { $days }-day writing streak
pace-stat-streak-none = No active streak
pace-stat-days-left = Writing days left: { $days }
pace-stat-rate = Need { $words } words a day
pace-stat-ahead = { $words } words ahead of pace
pace-stat-behind = { $words } words behind pace
pace-stat-on-track = Right on pace
pace-stat-no-deadline = No deadline set
