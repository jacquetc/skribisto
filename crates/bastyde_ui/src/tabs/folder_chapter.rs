...
//! scenes). A `SegmentedControl` selects the view; the **Synopsis** segment
//! (shared with the other folder tabs) is built now — Corkboard and Overview are
//! 🚧 future segments (FEATURES.md), shown disabled to mark the structure.
