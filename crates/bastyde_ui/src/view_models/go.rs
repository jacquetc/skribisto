...
//! Scene/Chapter/Note).
//!
//! **Minted where [`super::scene_focused`](super) is** — `shell/windows.rs`'s window
...
//! and written by [`EditorsViewModel`](super::EditorsViewModel) once it exists — the
...
///
/// [`EditorsViewModel::sync_active_item`]: super::EditorsViewModel::sync_active_item
#[derive(Clone)]
