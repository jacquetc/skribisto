...
fn body(
    ...
    let form = crate::settings::panes::typography::typography_rows(
        ctx,
        bastyde::widgets::FormLayout::new()
            .label_gap(12.0)
            .row_spacing(10.0),
    ...
    let selected: Signal<Option<bastyde::widgets::TabId>> = Signal::new(None);
...
fn themes_tab(
    ...
    .activate_on(bastyde::widgets::ActivateOn::SingleClick)
    ...
    VStack::new()
        .spacing(6.0)
        .child(bastyde::widgets::Expand::new().child(list))
        .child(
            HStack::new()
