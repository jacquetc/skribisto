...
use super::{
    dtos::{CreateTrashInfoDto, TrashInfoDto, UpdateTrashInfoDto},
    units_of_work::{TrashInfoReadUoWFactory, TrashInfoWriteUoWFactory},
};
use crate::TrashInfoRelationshipDto;
...
pub fn create_orphan(
    ...
    stack_id: Option<u64>,
    entity: &CreateTrashInfoDto,
) -> Result<TrashInfoDto> {
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::TrashInfo = entity.into();
...
pub fn create_orphan_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[CreateTrashInfoDto],
) -> Result<Vec<TrashInfoDto>> {
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::TrashInfo> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<TrashInfoDto>> {
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<TrashInfoDto>> {
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute_all()?.into_iter().map(|e| e.into()).collect())
}

pub fn get_multi(db_context: &DbContext, ids: &[EntityId]) -> Result<Vec<Option<TrashInfoDto>>> {
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc
        .execute_multi(ids)?
...
pub fn get_relationship(
    ...
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipManyUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipCountUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = TrashInfoReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableSetRelationshipUseCase::<TrashInfoRelationshipField, _>::new(
        uow_factory,
    );
...
pub fn move_relationship(
    ...
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableMoveRelationshipUseCase::<TrashInfoRelationshipField, _>::new(
        uow_factory,
    );
...
mod tests {
    ...
    fn create_one(ctx: &mut TestContext) -> TrashInfoDto {
        create_orphan(
            &ctx.db,
            &ctx.hub,
            &mut ctx.undo,
            None,
            &CreateTrashInfoDto::default(),
        )
        .unwrap()
    }
    ...
    fn test_update() {
        let mut ctx = TestContext::new();
        let created = create_one(&mut ctx);
        let update_dto: UpdateTrashInfoDto = created.into();
