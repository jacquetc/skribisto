...
pub fn set_relationship(
    ...
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::SetRelationshipUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
...
pub fn move_relationship(
    ...
    let uow_factory = TrashInfoWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::MoveRelationshipUseCase::<TrashInfoRelationshipField, _>::new(uow_factory);
...
mod tests {
    ...
    fn create_one(ctx: &mut TestContext) -> TrashInfoDto {
        create_orphan(&ctx.db, &ctx.hub, &CreateTrashInfoDto::default()).unwrap()
    }
