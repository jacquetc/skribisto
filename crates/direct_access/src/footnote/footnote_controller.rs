...
fn with_identity(mut e: common::entities::Footnote) -> common::entities::Footnote {
    if e.uid.is_nil() {
...
pub fn create_orphan(
    ...
    let entity_in: common::entities::Footnote = with_identity(entity.into());
...
pub fn create_orphan_multi(
    ...
    let uow_factory = FootnoteWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Footnote> = entities
        .iter()
