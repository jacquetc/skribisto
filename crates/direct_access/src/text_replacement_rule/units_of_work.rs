...
pub struct TextReplacementRuleWriteUoW {
    context: DbContext,
...
impl TextReplacementRuleWriteUoW {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        TextReplacementRuleWriteUoW {
...
impl CommandUnitOfWork for TextReplacementRuleWriteUoW {
    fn begin_transaction(&mut self) -> Result<()> {
        ...
        self.write_guard = Some(WriteTransactionGuard::acquire(
            &self.context,
            "text_replacement_rule_direct_write",
        )?);
...
impl use_cases::WriteUoW for TextReplacementRuleWriteUoW {
...
impl use_cases::OwnedWriteUoW for TextReplacementRuleWriteUoW {
    fn create_multi(
        &self,
        entities: &[TextReplacementRule],
        owner_id: EntityId,
...
pub struct TextReplacementRuleWriteUoWFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl TextReplacementRuleWriteUoWFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        TextReplacementRuleWriteUoWFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl use_cases::WriteUoWFactory for TextReplacementRuleWriteUoWFactory {
    type Entity = TextReplacementRule;
    fn create(&self) -> Box<dyn use_cases::WriteUoW<Entity = TextReplacementRule>> {
        Box::new(TextReplacementRuleWriteUoW::new(
            &self.context,
            &self.event_hub,
        ))
    }
...
impl use_cases::OwnedWriteUoWFactory for TextReplacementRuleWriteUoWFactory {
    type Entity = TextReplacementRule;
    fn create(&self) -> Box<dyn use_cases::OwnedWriteUoW<Entity = TextReplacementRule>> {
        Box::new(TextReplacementRuleWriteUoW::new(
            &self.context,
            &self.event_hub,
        ))
...
pub struct TextReplacementRuleReadUoW {
    context: DbContext,
    transaction: RefCell<Option<Transaction>>,
}

impl TextReplacementRuleReadUoW {
    pub fn new(db_context: &DbContext) -> Self {
        TextReplacementRuleReadUoW {
            context: db_context.clone(),
...
impl QueryUnitOfWork for TextReplacementRuleReadUoW {
...
impl use_cases::ReadUoW for TextReplacementRuleReadUoW {
    type Entity = TextReplacementRule;

    fn get(&self, id: &EntityId) -> Result<Option<TextReplacementRule>> {
        let transaction = self.transaction.borrow();
        let repo = repository_factory::read::create_text_replacement_rule_repository(
            transaction
                .as_ref()
                .ok_or_else(|| anyhow::anyhow!("No active transaction"))?,
        )?;
...
pub struct TextReplacementRuleReadUoWFactory {
    context: DbContext,
}

impl TextReplacementRuleReadUoWFactory {
    pub fn new(db_context: &DbContext) -> Self {
        TextReplacementRuleReadUoWFactory {
            context: db_context.clone(),
        }
    }
}

impl use_cases::ReadUoWFactory for TextReplacementRuleReadUoWFactory {
    type Entity = TextReplacementRule;
    fn create(&self) -> Box<dyn use_cases::ReadUoW<Entity = TextReplacementRule>> {
        Box::new(TextReplacementRuleReadUoW::new(&self.context))
    }
}
