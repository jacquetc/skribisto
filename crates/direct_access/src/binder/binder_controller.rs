...
use super::{
    dtos::{BinderDto, CreateBinderDto, UpdateBinderDto},
    units_of_work::{BinderReadUoWFactory, BinderWriteUoWFactory},
};
use crate::BinderRelationshipDto;
...
fn with_identity(mut e: common::entities::Binder) -> common::entities::Binder {
    if e.uid.is_nil() {
...
pub fn create_orphan(
    ...
    stack_id: Option<u64>,
    entity: &CreateBinderDto,
) -> Result<BinderDto> {
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::Binder = with_identity(entity.into());
...
pub fn create_orphan_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[CreateBinderDto],
) -> Result<Vec<BinderDto>> {
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Binder> = entities
        .iter()
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<BinderDto>> {
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<BinderDto>> {
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute_all()?.into_iter().map(|e| e.into()).collect())
}

pub fn get_multi(db_context: &DbContext, ids: &[EntityId]) -> Result<Vec<Option<BinderDto>>> {
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc
        .execute_multi(ids)?
...
pub fn update(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entity: &UpdateBinderDto,
) -> Result<BinderDto> {
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let entity_in: common::entities::Binder = entity.into();
...
pub fn update_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[UpdateBinderDto],
) -> Result<Vec<BinderDto>> {
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Binder> =
...
pub fn get_relationship(
    ...
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<BinderRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipManyUseCase::<BinderRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipCountUseCase::<BinderRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = BinderReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<BinderRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableSetRelationshipUseCase::<BinderRelationshipField, _>::new(uow_factory);
...
pub fn move_relationship(
    ...
    let uow_factory = BinderWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableMoveRelationshipUseCase::<BinderRelationshipField, _>::new(uow_factory);
...
mod tests {
    ...
    fn create_one(ctx: &mut TestContext) -> BinderDto {
        create_orphan(
            &ctx.db,
            &ctx.hub,
            &mut ctx.undo,
    ...
    fn test_update() {
        let mut ctx = TestContext::new();
        let created = create_one(&mut ctx);
        let update_dto: UpdateBinderDto = created.into();
    ...
    fn test_get_relationship_default() {
        ...
        let created = create_one(&mut ctx);
        let rel_ids =
            get_relationship(&ctx.db, &created.id, &BinderRelationshipField::BinderItems).unwrap();
    ...
    fn test_get_relationship_count_default() {
        ...
        let created = create_one(&mut ctx);
        let count =
            get_relationship_count(&ctx.db, &created.id, &BinderRelationshipField::BinderItems)
                .unwrap();
        assert_eq!(count, 0);
    }
}
