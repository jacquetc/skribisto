...
//! [`TitleBar`](teksilo::widgets::TitleBar) carries the title. Keep this
...
use teksilo::core::styles::{PanelVariant, SharedStandardItemStyle, StandardItemStyleConfig};
...
/// [`StandardItemStyle`](teksilo::core::styles::StandardItemStyle) recipe
...
/// (not `teksu!`) because the override wraps the button in a
...
fn link_button(
    ...
    Button::new(label.clone())
        ...
        .access_role(teksilo::core::accesskit::Role::Link)
}
