...
//!
//! **Per-window, not shared** — the same shape as [`crate::shared::FullscreenViewModel`]
...
use teksilo::prelude::{Signal, WindowPlacement, WindowState};
...
mod tests {
    use super::*;
    use teksilo::core::{TeksiloWindowId, WindowStateInit};
