...
impl CaretHighlightSettings {
    ...
    pub fn from_context(ctx: &mut teksilo::prelude::BuildContext) -> Self {
        use teksilo::prelude::SettingsExt;
        let scope = crate::settings::SettingsViewModel::new(ctx.settings()).highlight_scope();
    ...
    /// theme band opaque.
    pub fn document_color(c: teksilo::tokens::Color) -> Color {
