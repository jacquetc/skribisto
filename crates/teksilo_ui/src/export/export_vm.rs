...
use teksilo::prelude::*; // EventContext, Signal, tr!, lit!
...
pub fn scope_label(scope: &ExportScopeKind) -> teksilo::i18n::LocalizedString {
    match scope {
...
impl ExportViewModel {
    ...
    pub fn preset_chips(&self) -> Vec<teksilo::i18n::LocalizedString> {
    ...
    pub fn current_format_label(&self) -> teksilo::i18n::LocalizedString {
