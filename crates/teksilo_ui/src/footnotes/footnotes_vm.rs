...
struct Inner {
    ...
    /// (`crate::footnotes::dock::NoteBodyStyle::make_body`, via
...
impl FootnotesViewModel {
    ...
    /// `crate::footnotes::dock::NoteBodyStyle`). That gate is what keeps a self-typed
    ...
    ///
    /// Called by `crate::footnotes::dock::NoteBodyStyle::make_body` on every real
