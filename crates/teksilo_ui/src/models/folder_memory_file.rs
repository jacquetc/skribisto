...
pub fn dialog_start_in(
    ...
    req: teksilo::prelude::FileDialogRequest,
) -> teksilo::prelude::FileDialogRequest {
    match ctx
...
pub fn picker_starts_in(
    ctx: &teksilo::core::build_context::BuildContext,
    purpose: FolderPurpose,
    field: teksilo::widgets::FilePickerField,
) -> teksilo::widgets::FilePickerField {
    match ctx
        .app_state::<FolderMemoryService>()
        .and_then(|svc| svc.last(purpose))
    {
...
pub fn remember_pick(
    ctx: &teksilo::prelude::EventContext,
    purpose: FolderPurpose,
    result: &teksilo::prelude::FileDialogResult,
) {
    use teksilo::prelude::FileDialogResult as R;
    match result {
