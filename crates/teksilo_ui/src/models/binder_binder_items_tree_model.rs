...
//! Reactive model for the binder-item tree, backed by a Teksilo
...
//! [`first_changed_index`](teksilo::data::TreeDataSource::first_changed_index)
//! divergence, DnD cycle guard + plumbing) lives once in `teksilo_data`'s
