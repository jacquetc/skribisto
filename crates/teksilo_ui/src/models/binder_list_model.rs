...
//! itself — so the model keeps no `teksilo::data::ListModel`; it exposes a
...
mod imp {
    ...
    impl BinderListModel {
        ...
        pub fn wire(&self, ctx: &mut BuildContext) {
            ...
            // Project (re)load — guarded (loose form): `items()` always re-derives
