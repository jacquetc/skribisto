...
settings-field-user-initials-placeholder = Déduites
settings-field-user-initials-hint = Ce qu'un traitement de texte affiche en marge à côté de votre commentaire. Laissez vide pour les déduire de votre nom.
