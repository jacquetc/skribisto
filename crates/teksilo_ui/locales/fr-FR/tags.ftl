...
note-details-links = Liens
note-details-links-empty = Aucun lien pour l’instant. Ajoutez-en un pour pointer vers une autre entrée de votre bible narrative.
note-details-links-add = Lier à une note…
