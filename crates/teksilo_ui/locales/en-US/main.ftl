...
save-flush-failed = The save went through, but these documents could not be handed to it and are still unsaved: { $titles } ({ $error })
...
import-document-hunk-changed = Take this rewrite
