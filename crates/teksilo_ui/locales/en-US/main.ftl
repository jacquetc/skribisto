...
settings-field-user-initials-placeholder = Derived
settings-field-user-initials-hint = What a word processor shows beside your comment in the margin. Leave it blank to derive it from your name.
