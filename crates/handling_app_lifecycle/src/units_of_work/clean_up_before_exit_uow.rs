...
// ../use_cases/clean_up_before_exit_uc.rs exactly. The `write_guard`
// field/acquire in `begin_transaction` below is now plain generated output
// (Qleany v1.9.0+), not a hand-edit — see `common::database::write_guard`'s
// module doc.
...
impl CommandUnitOfWork for CleanUpBeforeExitUnitOfWork {
    fn begin_transaction(&mut self) -> Result<()> {
        ...
        self.write_guard = Some(WriteTransactionGuard::acquire(&self.context, "clean_up_before_exit")?);
