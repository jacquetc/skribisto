...
// ../use_cases/initialize_app_uc.rs exactly. The `write_guard` field/acquire
// in `begin_transaction` below is now plain generated output (Qleany
// v1.9.0+), not a hand-edit — see `common::database::write_guard`'s module
// doc.
...
// Actions mirror ../use_cases/initialize_app_uc.rs exactly.
