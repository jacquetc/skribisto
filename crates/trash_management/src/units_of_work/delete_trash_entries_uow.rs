...
use crate::use_cases::delete_trash_entries_uc::{
    DeleteTrashEntriesUnitOfWorkFactoryTrait, DeleteTrashEntriesUnitOfWorkTrait,
};
...
use common::event::TrashManagementEvent::DeleteTrashEntries;
...
// Unit of work for DeleteTrashEntries

pub struct DeleteTrashEntriesUnitOfWork {
    context: DbContext,
...
impl DeleteTrashEntriesUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        DeleteTrashEntriesUnitOfWork {
...
impl CommandUnitOfWork for DeleteTrashEntriesUnitOfWork {
    fn begin_transaction(&mut self) -> Result<()> {
        ...
        self.write_guard = Some(WriteTransactionGuard::acquire(&self.context, "delete_trash_entries")?);
...
//
// Exactly the same macros must be set in the use case uow trait file in ../use_cases/delete_trash_entries_uc.rs
//
...
impl DeleteTrashEntriesUnitOfWorkTrait for DeleteTrashEntriesUnitOfWork {
    fn publish_delete_trash_entries_event(&self, ids: Vec<EntityId>, data: Option<String>) {
        self.event_hub.send_event(Event {
            origin: Origin::TrashManagement(DeleteTrashEntries),
            ids,
            data,
        });
    }
...
pub struct DeleteTrashEntriesUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl DeleteTrashEntriesUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        DeleteTrashEntriesUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl DeleteTrashEntriesUnitOfWorkFactoryTrait for DeleteTrashEntriesUnitOfWorkFactory {
    fn create(&self) -> Box<dyn DeleteTrashEntriesUnitOfWorkTrait> {
        Box::new(DeleteTrashEntriesUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
