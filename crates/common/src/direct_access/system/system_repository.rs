...
impl<'a> SystemRepository<'a> {
    ...
    pub fn restore(
        ...
        {
            let child_ids: Vec<_> = store.recent_works.read().unwrap().keys().copied().collect();
            emit(
        ...
        {
            let child_ids: Vec<_> = store.trash_infos.read().unwrap().keys().copied().collect();
            emit(
        ...
        {
            let child_ids: Vec<_> = store.work_infos.read().unwrap().keys().copied().collect();
            emit(
