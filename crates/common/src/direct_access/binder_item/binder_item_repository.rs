...
impl<'a> BinderItemRepository<'a> {
    ...
    pub(crate) fn restore_subtree(
        ...
        {
            let live = store.binder_items.read().unwrap();
            for id in &ids {
        ...
        {
            let mut live = store.binder_items.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
        ...
        {
            let mut live_jn = store.jn_content_from_binder_item_contents.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
        ...
        {
            let mut live_jn = store.jn_binder_tag_from_binder_item_tags.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
