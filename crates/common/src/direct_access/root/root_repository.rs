...
impl<'a> RootRepository<'a> {
    ...
    pub(crate) fn restore_subtree(
        ...
        {
            let live = store.roots.read().unwrap();
            for id in &ids {
        ...
        {
            let mut live = store.roots.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
        ...
        {
            let mut live_jn = store.jn_system_from_root_system.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
        ...
        {
            let mut live_jn = store.jn_work_from_root_works.write().unwrap();
            for id in to_create.iter().chain(to_update.iter()) {
