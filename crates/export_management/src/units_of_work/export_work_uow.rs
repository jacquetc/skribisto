...
//
// Exactly the same macros (without thread_safe) must be set in the use case file in ../use_cases/export_work_uc.rs
//
#[macros::uow_action(entity = "Work", action = "GetRO", thread_safe = true)]
#[macros::uow_action(entity = "Work", action = "GetMultiRO", thread_safe = true)]
#[macros::uow_action(entity = "Binder", action = "GetRO", thread_safe = true)]
...
#[macros::uow_action(entity = "BinderTag", action = "GetRO", thread_safe = true)]
#[macros::uow_action(entity = "BinderTag", action = "GetMultiRO", thread_safe = true)]
#[macros::uow_action(entity = "Content", action = "GetRO", thread_safe = true)]
